...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kubercoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kubercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kubercoin transaction") + "\n" +
              "  kubercoin-tx [options] -create [commands]   " + _("Create hex-encoded kubercoin transaction") + "\n" +
              "\n";
