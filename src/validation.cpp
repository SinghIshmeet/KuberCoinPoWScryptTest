...
#if defined(NDEBUG)
# error "Kubercoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Kubercoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s KCN additional fees, %d delta bytes\n",
